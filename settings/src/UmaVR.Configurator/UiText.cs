...
internal static class UiText
{
    ...
    private static Dictionary<string, string> Korean() => new()
    {
        ...
        ["ControllerDescription"] = "기본값은 오른손 pointer ray·Trigger·A/B·이동, 왼손 auxiliary panel Grip·Snap Turn입니다. 손 역할 전환을 켜면 왼손 pointer ray·Trigger·X/Y·이동, 오른손 panel Grip·Snap Turn으로 primary/secondary 역할 전체가 함께 바뀝니다. Smooth Turn은 구현되지 않아 표시하지 않습니다.",
        ["Save"] = "저장",
        ["Reload"] = "다시 불러오기",
        ["Defaults"] = "기본값",
        ["Export"] = "내보내기...",
    ...
    private static Dictionary<string, string> English() => new()
    {
        ...
        ["ControllerDescription"] = "Default: right pointer ray, Trigger, A/B and locomotion; left auxiliary-panel Grip and Snap Turn. Swap assigns pointer ray, Trigger, X/Y and locomotion to the left hand, and panel Grip and Snap Turn to the right. Smooth Turn is not implemented and is not shown.",
        ["Save"] = "Save",
        ["Reload"] = "Reload",
        ["Defaults"] = "Defaults",
        ["Export"] = "Export...",
    ...
    private static Dictionary<string, string> Japanese() => new()
    {
        ...
        ["ControllerDescription"] = "初期設定では右手がポインター・Trigger・A/B・移動、左手が補助パネルのGrip・スナップターンを担当します。交換すると左手がポインター・Trigger・X/Y・移動、右手がパネルGrip・スナップターンを担当します。未実装のSmooth Turnは表示しません。",
        ["Save"] = "保存",
        ["Reload"] = "再読み込み",
        ["Defaults"] = "初期値",
        ["Export"] = "エクスポート...",
