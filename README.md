...
Virtual Desktop의 VDXR 경로로 실기 검증했습니다. 현재 공식 버전은 **v0.1.1**입니다.
...
- [v0.1.1 릴리스 정보](docs/releases/v0.1.1.md)
...
- 상한 없는 이동 기준 속도와 월드 스케일 연동 자동 속도 보정
...
- [umamusume-localify](https://github.com/Kimjio/umamusume-localify) — UmaVR가 사용하는 Localify 로더 및 `externalDlls` 통합 기반
